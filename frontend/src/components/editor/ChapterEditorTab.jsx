...
const ChapterEditorTab = ({
    ...
    const formatMarkDown = (content) => {
        return content
            ...
            // Bold and Italic
            .replace(/\*\*(.*?)\*\*/g, '<strong clas="font-semibold">$1</strong>')
            .replace(/\*(.*?)\*/g, '<em class="italic">$1</em>')

            // BlockQuotes
            .replace(/^> (.*$)/gm, '<blockquote clas="border-l-4 border-violet-500 pl-4 italic text-gray-700 my-4">$1 </blockquote>')
