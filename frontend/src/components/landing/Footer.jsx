    ...
    return (
        <footer className="relative bg-gradient-to-br from-gray-950 via-gray-950 to-violet-950 text-white overflow-hidden">
            <div className="absolute inset-0 opacity-5">
                <div className="absolute top-0 right-0 w-96 bg-violet-500 rounded-full blur-3xl"></div>
            </div>
                ...
                <div className="py-16 grid grid-cols-1 md:grid-cols-12 gap-12">
                    ...
                    <div className="md:col-span-5 space-y-6">
                        ...
                        <div className="flex items-center space-x-3 pt-2">
                            ...
                            <a
                                href="#"
                                className="w-10 h-10 bg-white/5 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-200 hover: scale-110"
                                aria-label="LinkedIn"
                            >
                            ...
                            <a
                                href="#"
                                className="w-10 h-10 bg-white/5 hover:bg-gray-600 rounded-lg flex items-center justify-center transition-all duration-200 hover: scale-110"
                                aria-label="Github"
                            >
