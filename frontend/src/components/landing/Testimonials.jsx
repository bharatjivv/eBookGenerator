        ...
        <div id="testimonials" className="relative py-24 lg:py-32 bg-gradient-to-br from-violet-50 via-purple-50 to-white overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
                ...
                <div className="text-center mb-20 space-y-4">
                    ...
                    <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 tracking-tight">Loved by Creators <span className="block mt-2 bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">Everywhere</span></h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {TESTIMONIALS.map((testimonial, index) => (
                        <div className="group relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-100 hover:border-violet-200 hover:shadow-2xl hover:shadow-violet-500/0 transition-all duration-300 hover:-translate-y-2"
                            key={index}>
