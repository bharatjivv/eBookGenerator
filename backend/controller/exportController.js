...
const processMardownToDocs = (markdown) => {
  ...
  try {
    ...
    if (book.coverImage && !book.coverImage.includes("pravatar")) {
      ...
      try {
        ...
        console.error(`Couldnot embed image: ${imagePath}`, imgErr);
      }
    }
    ...
    res.setHeader(
      "Content-Type",
      "application/vnd.openmxlformats-officedocument.wordprocessingml.document",
    );
    res.setHeader(
      "Content-Disposition",
